    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "marcin@kul.com", "Marcin", "Kulik" },
                    { 2, "m@zrebak.pl", "Michał", "Źrebak" },
                    { 3, "k@kow.kk", "Kacper", "Kowalski" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1985, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Mirosław", "Księżyk" },
                    { 2, new DateTime(1999, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Jakub", "Zlewek" }
                });

            migrationBuilder.InsertData(
                table: "Prescription",
                columns: new[] { "IdPrescription", "Date", "DueDate", "IdDoctor", "IdPatient" },
                values: new object[] { 1, new DateTime(2022, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1 });
